...
ExprRef PMESH_L2_ILA::unknown_range(unsigned low, unsigned high) {
...
ExprRef PMESH_L2_ILA::lConcat(const std::vector<ExprRef> & l) {
  assert(l.size() >= 1);
  auto ret = l[0];
...
FuncRef PMESH_L2_ILA::unknown(unsigned width) {
