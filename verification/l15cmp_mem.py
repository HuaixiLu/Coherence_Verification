...
f1 = open('./verification/l15cmp_mem.v', 'w+')
...
f1.write( "  input wire [`TAG_WIDTH - 1 : 0] msg2_load_tag,\n \n")
...
f1.write( "reg [`MSG_WIDTH - 1 : 0]  msg2_type_core [%d - 1 : 0];\n" % (CORE_NUMBER))
f1.write( "reg [`DATA_WIDTH - 1 : 0]  msg2_data_core [%d - 1 : 0];\n" % (CORE_NUMBER)) 
f1.write( "reg [`TAG_WIDTH - 1 : 0]  msg2_tag_core [%d - 1 : 0];\n" % (CORE_NUMBER)) 
f1.write( "reg [`MESI_WIDTH - 1 : 0]  mesi_send_core [%d - 1 : 0];\n\n" % (CORE_NUMBER)) 
...
f1.write( "wire [`MSG_WIDTH - 1 : 0]  msg1_type_core [%d - 1 : 0];\n" % (CORE_NUMBER)) 
f1.write( "wire [`DATA_WIDTH - 1 : 0] msg1_data_core [%d - 1 : 0];\n" % (CORE_NUMBER))
f1.write( "wire [`TAG_WIDTH - 1 : 0]  msg1_tag_core  [%d - 1 : 0];\n" % (CORE_NUMBER)) 

f1.write( "wire [`MSG_WIDTH - 1 : 0]  msg3_type_core [%d - 1 : 0];\n" % (CORE_NUMBER)) 
f1.write( "wire [`DATA_WIDTH - 1 : 0] msg3_data_core [%d - 1 : 0];\n" % (CORE_NUMBER)) 
f1.write( "wire [`TAG_WIDTH - 1 : 0]  msg3_tag_core  [%d - 1 : 0];\n \n" % (CORE_NUMBER))
...
f1.write( "  end\n")
f1.write( "  else if (!(msg2_type == `MSG_TYPE_STORE_MEM | msg2_type == `MSG_TYPE_LOAD_MEM)) begin\n")
...
f1.write( "    msg3_data_mem <= mem_data[msg2_load_tag];\n")
f1.write( "    msg3_tag_mem <= msg2_load_tag;\n")
f1.write( "    if (msg2_type == `MSG_TYPE_STORE_MEM) mem_data[msg2_tag] <= msg2_data;\n")
f1.write( "    end\n")
f1.write( "  else\n")
f1.write( "    msg3_type_mem <= `MSG_TYPE_EMPTY;\n")
f1.write( "end\n")
