...
f1.write("assert -name same_msg1 {ccp_fsm.msg1_type == ccp_ila.msg1_type && ccp_fsm.msg1_tag == ccp_ila.msg1_tag && ccp_fsm.msg1_source == ccp_ila.msg1_source}\n")
f1.write("assert -name same_msg2 {ccp_fsm.msg2_type == ccp_ila.msg2_type && ccp_fsm.msg2_tag == ccp_ila.msg2_tag && ccp_fsm.msg2_source == ccp_ila.msg2_source}\n")
f1.write("assert -name same_msg3 {ccp_fsm.msg3_type == ccp_ila.msg3_type && ccp_fsm.msg3_source == ccp_ila.msg3_source && (ccp_fsm.msg3_type != `MSG_TYPE_LOAD_MEM_ACK || ccp_fsm.msg3_tag == ccp_ila.msg3_tag)}\n")
